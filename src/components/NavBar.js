...
const CustomLink = ({href, title,className=""}) =>{
    ...
    return(
        <Link href={href} className={`${className} relative group`}>
            ...
            ease during-300 ${router.asPath === href ? 'w-full':'w-0'} 
            dark:bg-light`}            
            >&nbsp;</span>
        </Link>
    )
  ...
  return (
   ...
   className='w-full px-32 py-8 font-medium flex item-center justify-between
    ...
    <div className={`w-full flex justify-between items-center lg:hidden`}>
        ...
        <nav className="flex item-center justify-center flex-warp">
            <motion.a href="https://twitter.com/RohanGope6"target="_blank"
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mr-3"
            >
            ...
            <motion.a href="https://github.com/Darkrider0007"target="_blank"
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mx-3">
                <GithubIcon/>
            </motion.a>
            <motion.a href="https://www.linkedin.com/in/rohan-gope-a96072199/"target="_blank" 
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mx-3">
                <LinkedInIcon/>
            </motion.a>
            <motion.a href="https://leetcode.com/Rohan007_2/"target="_blank" 
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mx-3 ">
                <LeetcodeIcon/>
        ...
        className={`min-w-[70vw] flex flex-col justify-between z-30 items-center
            ...
            rounded-lg backdrop-blur-md py-32`}>
                <nav className='flex items-center flex-col justify-center'>
                    ...
                    <CustomMobileLink href="/articles" title="Articles" className=" "  toggle={handelClick} />
                </nav>
            
                <nav className="flex item-center justify-center flex-warp mt-2">
                    <motion.a href="https://twitter.com/RohanGope6"target="_blank"
                    whileHover={{y:-2}}
                    whileTap={{scale:0.9}}
    ...
    <div className='absolute left-[50%] md:left-[35%] top-2 translate-x-[50%]'> 
        <Logo/>
    </div>
   </header>
  )
